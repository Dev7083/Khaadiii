    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:space-x-10">
        ...
        <div className="w-full md:w-2/3 lg:w-1/2">
          ...
          <h2 className="mt-4 text-3xl font-bold text-black">Log In for our weekly products Update</h2>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 flex items-center space-x-4">
              ...
              <span className="text-sm font-semibold text-gray-700">Join 5000+ Customers</span>
            </div>
          </div>
          <form className="mt-6">
