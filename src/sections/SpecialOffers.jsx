...
const SpecialOffers = () => {
  return (
    <section className="overflow-hidden">
      ...
      <h2 className="text-sm font-semibold tracking-widest text-gray-500 flex justify-center mb-6">Special Offer</h2>
        <div className="mx-auto flex flex-wrap items-center lg:w-4/5">
          ...
          <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
            <h2 className="text-sm font-semibold tracking-widest text-gray-500">Pacify R series</h2>
            <h1 className="my-4 text-3xl font-semibold text-black">Pacify RX-21</h1>
            ...
            <div className="flex items-center justify-between">
              <span className="title-font text-xl font-bold text-gray-900">₹1,199</span>
              <button
                type="button"
